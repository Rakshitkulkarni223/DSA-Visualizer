...
// Real Tree visualization logic is out of scope for Phase 1
...
export function TreeVisualizer({ structure }: TreeVisualizerProps) {
  return (
    <div className="visualizer-panel visualizer-panel--stub">
      <div className="visualizer-panel__header">
        ...
        <span className="visualizer-panel__badge">tree</span>
      </div>
