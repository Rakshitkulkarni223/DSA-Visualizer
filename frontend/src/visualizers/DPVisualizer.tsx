...
// Real DP visualization logic is out of scope for Phase 1
...
export function DPVisualizer({ structure }: DPVisualizerProps) {
  return (
    <div className="visualizer-panel visualizer-panel--stub">
      <div className="visualizer-panel__header">
        ...
        <span className="visualizer-panel__badge">dp</span>
      </div>
