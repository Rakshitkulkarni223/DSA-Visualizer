...
// Real Trie visualization logic is out of scope for Phase 1
...
export function TrieVisualizer({ structure }: TrieVisualizerProps) {
  return (
    <div className="visualizer-panel visualizer-panel--stub">
      <div className="visualizer-panel__header">
        ...
        <span className="visualizer-panel__badge">trie</span>
      </div>
