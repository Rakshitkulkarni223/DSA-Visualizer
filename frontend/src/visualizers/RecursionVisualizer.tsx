...
// Real Recursion visualization logic is out of scope for Phase 1
// (see docs/CONTRACT.md "Non-goals for Phase 1").

import type { Structure } from '../types/schema'

export interface RecursionVisualizerProps {
  structure: Structure
}

export function RecursionVisualizer({ structure }: RecursionVisualizerProps) {
  return (
    <div className="visualizer-panel visualizer-panel--stub">
      <div className="visualizer-panel__header">
        ...
        <span className="visualizer-panel__badge">recursion</span>
      </div>
